            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <input
                  ...
                  className="w-full rounded-lg border border-gray-300 px-4 py-3 text-gray-800 focus:ring-2 focus:ring-pink-500 focus:outline-none disabled:bg-gray-100"
                />
              </div>
              <div>
                <input
              ...
              <div>
                <textarea
                  ...
                  required
                  disabled={status === "loading"}
                  className="w-full resize-none rounded-lg border border-gray-300 px-4 py-3 text-gray-800 focus:ring-2 focus:ring-pink-500 focus:outline-none disabled:bg-gray-100"
                ></textarea>
              </div>
